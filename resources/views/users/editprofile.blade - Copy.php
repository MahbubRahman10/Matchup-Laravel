			...
			<div class="col-md-3" id="usersidebar">
				...
				<div class="sidebar-menu">
					<ul>
						...
						<li><a href="/profile/setting" class="sidebar-menu"><i class="fab fa-facebook-messenger"></i> Inbox </a></li>
						...
						<li><a href="/profile/membership" class="sidebar-menu"><i class="fas fa-user-lock"></i> Membership </a></li>
						...
						<div class="col-sm-6" style="margin-top: 10px;">
								<div class="form-group">
									...
									<div class="key{{ $errors->has('image') ? ' has-error' : '' }}">
										...
										<div id="featured_image" class="featured_image">
											<style type="text/css">
											#featured_image img{
												width:500px;
												height: 460px;  
										...
										<img src="/{{$user->image}}" id="uimg" class="uimg">
										</div>
										<label class="data-url"></label>

										<input type="file" id="fileupload" name="image" id="afiles"  onchange="loadFile(event)" style="display: none;">
									</div>
									<br>
							...
							<div class="col-sm-4">
								<div class="form-group">
									<div class="key{{ $errors->has('address') ? ' has-error' : '' }}">
										...
										<textarea value="Address"  name="address" class="details" placeholder="Write Your Address" onfocus="this.value = '';" onblur="	if (this.value == '') {this.value = 'Message'}"> {{ $user->userinfo->address }} </textarea>
									</div>
...
{{-- <div class="featured_image">
	<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/29841/dog.jpg" alt="" />
</div> --}}
	...
	<script type="text/javascript">
		var loadFile = function(event) {
			...
			function_two(readURL); 


		};


		function function_two(cs){
			alert(cs)
			var $image = readURL;
			originalData = {};
